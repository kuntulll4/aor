...
def lisensi():
	...
	res=ses.get('https://app.cryptolens.io/api/key/Activate?token=WyIxODQ4NzY4MyIsIm81TEE3M2padmY0a0FoMVFrTXQyV2ZEMjBudURMTVNUeU5NSUZjWm8iXQ==&ProductId=14919&Key='+lisensikuni[0]).json()
