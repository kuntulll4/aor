...
def lisensi():
	...
	res=ses.get('https://app.cryptolens.io/api/key/Activate?token=WyIxODQ4NTQ4MyIsIkhib3M4QnFIc0xUUkl6V2tLaWROQzQ5UTVkMnpxckt4MGpLSFlaT2wiXQ==&ProductId=14919&Key='+lisensikuni[0]).json()
